...
Позволяет передавать сущности другим командам.
...
* переименуйте данный мод в transfer_entities_*версия*, где *версия* это версия мода, которую вы скачали (например, 1.0.1)
